...
# ---------------------------------------- Overview: Context and Project Goals --------------------------------------- #

st.title("Context and Project Goals")
...
st.write("Given this issue, my project will aim to resolve the lack of information surrounding Medicare suppliers and their assignment status, which I will do in two ways. First, I will create a map, showing users all of the suppliers that offer the goods and services they require, and whether or not they accept assignment. Secondly, I will examine several datasets to identify trends concerning suppliers, specialities and supplies, assignment status, and more general data looking at the effects of Medicare on public health.")