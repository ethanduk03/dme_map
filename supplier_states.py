...
# Write preview of newly created columns to web app
...
# Create scatterplot of supplier count and uninsured rate change, with trendline (regression) and horizontal line on the x-axis to highlight negative values
...
# Create scatterplot of supplier count and medicaid enrollment change, with trendline (regression)
...
# Create histogram of Assignment Acceptance ratio in each state, add horizontal line to display the mean ratio with a red line
